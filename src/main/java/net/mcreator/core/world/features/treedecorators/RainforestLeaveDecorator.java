...
public class RainforestLeaveDecorator extends LeaveVineDecorator {
	public static final RainforestLeaveDecorator INSTANCE = new RainforestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("rainforest_tree_leave_decorator");
