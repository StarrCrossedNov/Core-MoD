...
public class SilverOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("core:silver_ore", FEATURE,
				new OreConfiguration(SilverOreFeatureRuleTest.INSTANCE, CoreModBlocks.SILVER_ORE.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("core:silver_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(10), InSquarePlacement.spread(),
	...
	private static class SilverOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("core:silver_ore_match"), CUSTOM_MATCH);
		}
